...
{
    public abstract class InitializeWorldBorder : IServerPacket
    {
        ...
        public sealed class V755_758 : InitializeWorldBorder
        {
        ...
        public sealed class V759_769 : InitializeWorldBorder
        {
            public override void Deserialize(ref MinecraftPrimitiveReader reader, int protocolVersion)
            {
                X = reader.ReadDouble();
