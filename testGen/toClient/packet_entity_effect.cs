...
{
    public abstract class EntityEffect : IServerPacket
    {
        public int EntityId { get; set; }
        public int Duration { get; set; }

        public sealed class V340_757 : EntityEffect
        {
        ...
        public sealed class V758 : EntityEffect
        {
            public override void Deserialize(ref MinecraftPrimitiveReader reader, int protocolVersion)
            {
                EntityId = reader.ReadVarInt();
        ...
        public sealed class V759_763 : EntityEffect
        {
            public override void Deserialize(ref MinecraftPrimitiveReader reader, int protocolVersion)
            {
                EntityId = reader.ReadVarInt();
                ...
                Duration = reader.ReadVarInt();
                HideParticles = reader.ReadSignedByte();
                FactorCodec = reader.ReadOptional<NbtTag?>(r_0 => r_0.ReadNbtTag(true));
            }
        ...
        public sealed class V764_765 : EntityEffect
        {
            public override void Deserialize(ref MinecraftPrimitiveReader reader, int protocolVersion)
            {
                EntityId = reader.ReadVarInt();
                ...
                Duration = reader.ReadVarInt();
                HideParticles = reader.ReadSignedByte();
                FactorCodec = reader.ReadOptional<NbtTag?>(r_0 => r_0.ReadNbtTag(false));
            }
        ...
        public sealed class V766_769 : EntityEffect
        {
            public override void Deserialize(ref MinecraftPrimitiveReader reader, int protocolVersion)
            {
                EntityId = reader.ReadVarInt();
