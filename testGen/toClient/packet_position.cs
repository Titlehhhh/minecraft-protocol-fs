...
{
    public abstract class Position : IServerPacket
    {
        ...
        public sealed class V340_754 : Position
        {
        ...
        public sealed class V755_761 : Position
        {
            public override void Deserialize(ref MinecraftPrimitiveReader reader, int protocolVersion)
            {
                X = reader.ReadDouble();
        ...
        public sealed class V762_767 : Position
        {
            public override void Deserialize(ref MinecraftPrimitiveReader reader, int protocolVersion)
            {
                X = reader.ReadDouble();
