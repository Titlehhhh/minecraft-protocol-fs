...
{
    public abstract class SpawnEntity : IServerPacket
    {
        ...
        public sealed class V340_404 : SpawnEntity
        {
        ...
        public sealed class V477_758 : SpawnEntity
        {
            public override void Deserialize(ref MinecraftPrimitiveReader reader, int protocolVersion)
            {
                EntityId = reader.ReadVarInt();
        ...
        public sealed class V759_769 : SpawnEntity
        {
            public override void Deserialize(ref MinecraftPrimitiveReader reader, int protocolVersion)
            {
                EntityId = reader.ReadVarInt();
