...
{
    public abstract class SetSlot : IServerPacket
    {
        public short Slot { get; set; }
        public Slot Item { get; set; }

        public sealed class V340_755 : SetSlot
        {
        ...
        public sealed class V756_765 : SetSlot
        {
            public override void Deserialize(ref MinecraftPrimitiveReader reader, int protocolVersion)
            {
                WindowId = reader.ReadSignedByte();
        ...
        public sealed class V766_767 : SetSlot
        {
            public override void Deserialize(ref MinecraftPrimitiveReader reader, int protocolVersion)
            {
                WindowId = reader.ReadSignedByte();
        ...
        public sealed class V768_769 : SetSlot
        {
            public override void Deserialize(ref MinecraftPrimitiveReader reader, int protocolVersion)
            {
