    ...
    let explosion =
        packet "ExplosionPacket" Play Clientbound All {
            ...
            wire (Until 754) [
                ...
                read "affectedBlockOffsets" (Array(Named "ExplosionBlockOffset", TypedCount I32)) "AffectedBlockOffsets"
                read "playerMotionX"        F32 "PlayerMotionX"
                read "playerMotionY"        F32 "PlayerMotionY"
                read "playerMotionZ"        F32 "PlayerMotionZ"
            ]

            wire (Between(755, 760)) [
                read "x"                    F32 "X"
                read "y"                    F32 "Y"
                read "z"                    F32 "Z"
                read "radius"               F32 "Radius"
                read "affectedBlockOffsets" (Array(Named "ExplosionBlockOffset", VarIntCount)) "AffectedBlockOffsets"
                read "playerMotionX"        F32 "PlayerMotionX"
                read "playerMotionY"        F32 "PlayerMotionY"
                read "playerMotionZ"        F32 "PlayerMotionZ"
            ]
